...
#
# This is a start at tests to verify PDLA operation with pdls having
...
use PDLA;
$PDLA::BIGPDLA = 1;  # should this be the defaults for 64bit index support?

# Tests for PDLA::Core
#
# NOTE: pdl and PDLA->new can't really be tested since the corresponding
#       perl data may be 10-100x bigger than the end pdl element sizes.
#
# A lot of these PDLA::Core tests simply check that these routines don't
...
my $bbb = $aaa->slice(":,3");
ok( $bbb->sum == $bbb->nelem, "slices of slices of giant PDLAs seem to work right");
