...
use strict;
use warnings;
use PDL::Complex::Inline Pdlpp => 'DATA';
use parent 'PDL::Exporter', 'PDL';
use PDL::Core;
use PDL::Slices;
use PDL::Types;
use PDL::Bad;
...
our @EXPORT_OK = qw(
    i Ctan
    Catan re im cplx real r2C i2C Cr2p Cp2r Cadd Csub Cmul Cprodover
    Cscale Cdiv Ccmp Cconj Cabs Cabs2 Carg Csin Ccos Cexp Clog Cpow
    Csqrt Casin Cacos Csinh Ccosh Ctanh Casinh Cacosh Catanh Cproj Croots
    rCpolynomial
);
...
sub i2C($) {
    my $r = __PACKAGE__->initialize; &PDL::Complex::_i2C_int($_[0], $r); $r
}
*PDL::i2C = \&i2C;
