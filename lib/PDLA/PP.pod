...
will call is _<funcname>_int. If you wish to define the Perl function
elsewhere (such as in a C<pp_addpm> call), you can give any true value
for C<PMCode> such as C<#>, and it will still trigger the generation of
the obfuscated name.
