...
within L<perldla|PDLA::perldla> or L<pdl2|PDLA::Perldl2> gives a demonstration of some of the things
...
L<perldla|PDLA::perldla> or L<pdl2|PDLA::Perldl2> or the C<-b> option to
...
accessible from the C<perldla> or C<pdl2> shells - using the C<badinfo> command - and the C<pdladoc>
