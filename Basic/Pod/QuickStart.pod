...
Perl code C<$x = $y + $c>, where C<$y> and C<$c> are large datasets
...
via a null-method modifier to a PDLA:
  ...
  $y = $x->($x1:$x2,$y1:$y2,($z1)); # Take subsection

Here, C<$x> is a 3-dimensional variable, and C<$y> gets a planar
...
otherwise C<$y> would be three-dimensional with a third dimension of order 1.
