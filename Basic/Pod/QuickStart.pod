...
I<perldla> or I<pdl2> shells and from the command line, using the C<pdladoc> program.
...
There is also an interactive shell, C<perldla> or C<pdl2>, see I<perldla>
...
The Perl script C<pdl2> (or C<perldla>) provides a simple command line interface
