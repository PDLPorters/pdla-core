...
To start the interactive shell, open a terminal and run C<perldla> or C<pdl2>.
...
C<perldla> or C<pdl2> shell) you must start the program with C<use PDLA;>.
