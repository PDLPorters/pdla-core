...
can do
	...
	$c = add($x,$b);
	# or
	add($x,$b,($c=null)); # Alternative form, useful if $c has been
...
really huge piddles, you can do
	...
	for(some long loop) {
		# munge a,b
		add($x,$b,$c);
		# munge c, put something back to x,b
	}
...
where $x is of type C<PDLA_Float> and $b of type C<PDLA_Short>? With the signature
