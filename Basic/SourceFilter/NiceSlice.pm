...
# save eval of findslice that should be used within perldla or pdl2
# as a preprocessor
sub perldlpp {
 my ($class, $txt) = @_;
 local($_);
...
NiceSlice is loaded automatically in the perldla or pdl2 shell, but (to avoid
...
=head1 Use in scripts and C<perldla> or C<pdl2> shell
...
the L<perldla|perldla> or L<pdl2|PDLA::Perldl2> shells by switching on
