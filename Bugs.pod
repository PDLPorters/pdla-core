...
L<https://github.com/PDLPorters/pdla-core/issues>.
...
The full output of C<perldla -V> 
...
C<perl -Mblib perldla -V> from the top level of the PDLA build directory.

=item *

The bug description and how to reproduce it.

Short examples using the PDLA shells, C<pdla2> or C<perldla>, are excellent!
...
information (including the output of C<perldla -V>)
...
check L<http://search.cpan.org/search?dist=PDLA>.

Also, you can check the FAQ at L<http://pdl.perl.org/?docs=FAQ&title=PDLA::FAQ>.
...
L<https://github.com/PDLPorters/pdla-core>.
